...
var fuelSvc = {
	...
	newRequest: func() {
		if (pts.Options.configName.getValue() == "A320-200-CFM") {
		...
		} elsif (pts.Options.configName.getValue() == "A320-200-IAE") {
	...
	refuel: func() {
		...
		if (pts.Options.configName.getValue() == "A320-200-CFM" and me.Nodes.requestTotalLbs.getValue() > 28229.9) {
			me._needCenter = 1;
		} elsif (pts.Options.configName.getValue() == "A320-200-IAE" and me.Nodes.requestTotalLbs.getValue() > 27591.8) {
			me._needCenter = 1;
		} elsif ((pts.Options.configName.getValue() == "A320neo-CFM" or pts.Options.configName.getValue() == "A320neo-PW") and me.Nodes.requestTotalLbs.getValue() > 27357.8) {
			me._needCenter = 1;
		} else {
			me._needCenter = 0;
		}
